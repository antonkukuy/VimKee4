...
#If WInActive("ahk_group VimGroup") && (VimMode == "Insert")
~a::  ; ;
Input, UserInput, I C T0.38 *,,aa,as,ad,af,фф,фы,фв,фа,вф,аф,s,d,f,ы,в,а,фф
...
;~sc1F::   ;s
~s::   ;s
Input, UserInput, I C T0.38 *,,sa,sd,sf,ыф,ыв,ыа,аы,вы,a,d,f,ф,ы,а
SetKeyDelay, -1
if UserInput = sa
    Send, {backspace 1}m
...
;~sc20::  ; d
~d::  ; d
Input, UserInput, I C T0.38 *,,da,ds,df,вф,вы,ва,a,s,f,ф,ы,а
SetKeyDelay, -1
if UserInput = da
    Send, {backspace 1}r
else if UserInput = вф
...
;~sc21::  ; f
~f::  ; f
Input, UserInput, I T0.38  *,,ff,fa,fs,fd,аа,аф,аы,ав,a,s,d,ф,ы,в
SetKeyDelay, -1
if UserInput = fa
    Send, {backspace 1}b
